...
import { safeCompare, sha256 } from '@/features/ecommpanel/server/crypto';
...
export function hasValidCustomerCsrf(req: NextRequest, csrfToken: string, cookieName: string): boolean {
...
export function validateCustomerRequestFingerprint(req: NextRequest, userAgentHash: string, ipHash: string): boolean {
