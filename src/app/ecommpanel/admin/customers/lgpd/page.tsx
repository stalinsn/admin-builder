    ...
    return (
      <section className="panel-grid">
        <article className="panel-card panel-card-hero panel-card-hero--compact">
          ...
          <p className="panel-muted">Se você quiser usar a fila de exportação, retenção e anonimização, volte o workspace de contas para o modo nativo em <strong>/ecommpanel/admin/customers</strong>.</p>
        </article>
      </section>
    );
  }
